...
@Log4j2
public class TCPClientWorker6 implements ClientWorker {
    // handler
    ...
    public TCPClientWorker6(@Qualifier("jsonPayloadEncoder") MessageToMessageEncoder<Payload> payloadEncoder,
